...
BUILDIN(getmapflag)
{
	...
	if(m >= 0) {
		switch(i) {
			...
			case MF_NOGUILDSTORAGE:     script_pushint(st,map->list[m].flag.noguildstorage); break;
		}
	}
...
BUILDIN(setmapflag) {
	...
	if(m >= 0) {
		switch(i) {
			...
			case MF_NOSTORAGE:          map->list[m].flag.nostorage = 1; break;
			case MF_NOGUILDSTORAGE:     map->list[m].flag.noguildstorage = 1; break;
		}
	}
...
BUILDIN(removemapflag) {
	...
	if(m >= 0) {
		switch(i) {
			...
			case MF_NOGUILDSTORAGE:     map->list[m].flag.noguildstorage = 0; break;
		}
	}
...
/*==========================================
 * Displays a message for the player only (w/ colors)
 *------------------------------------------*/
